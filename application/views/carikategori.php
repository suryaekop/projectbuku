...
<div class="container">
<h1>Pencarian Kategori Buku</h1>
<form action="<?= base_url("welcome/cari_action_category")?>" class="form-horizontal" name="formtambah" method="post" id="formtambah">
    <div class="form-group" style="margin-top: 25px;">
        <label for="">Cari Kategori Buku</label>
        <label for="">:</label>
        <input type="text" name="nama_kategori" id="nama_kategori" placeholder="Ketik Kategori Buku" size="30">
